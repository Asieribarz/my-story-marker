...
- **Tope de 100.000 tokens de ventana de contexto por agente.** Vale para cada subagente de la novela: lo que le pases —ficha, contexto recuperado, guía de estilo, capítulos anteriores— tiene que caber ahí. Es el límite que obliga a que el Recuperador de contexto seleccione en vez de volcar; el reparto por bloques y el orden de recorte están en `docs/architecture.md` §6.3.
